...
- PL-7 through PL-10 are all merged into `main`.
- `README.md` at the project root now has the full setup/run/dev instructions (Docker quick start, local dev without Docker, test commands) - refer to it instead of duplicating that here.
